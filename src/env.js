...
export const env = createEnv({
  ...
  server: {
    ...
    LINE_CUSTOMER_PROD_BOT_CHANNEL_ACCESS_TOKEN: z.string().min(1).optional(),
    LINE_CUSTOMER_PROD_BOT_CHANNEL_SECRET: z.string().min(1).optional(),
    LINE_CUSTOMER_TEST_BOT_CHANNEL_ACCESS_TOKEN: z.string().min(1).optional(),
    LINE_CUSTOMER_TEST_BOT_CHANNEL_SECRET: z.string().min(1).optional(),
    ENABLE_TEST_MODE: z.enum(["true", "false"]).default("false"),
    ENABLE_SERVICE_REQUEST_PROMPTS: z.enum(["true", "false"]).default("false"),
  ...
  runtimeEnv: {
    ...
    ENABLE_SERVICE_REQUEST_PROMPTS: process.env.ENABLE_SERVICE_REQUEST_PROMPTS,
